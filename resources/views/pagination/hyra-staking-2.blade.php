...
@section('content')
<div id="hyra-staking">
    <section class="banner-hyra-staking">
        <div class="container-lg">
            <h1 class="title-banner">GETTING STARTED HYRA STAKING </h1>
        </div>
    </section>
    <section class="page-hyra-staking">
        <div class="container-lg">
            <div class="row menu-hyra">
                ...
                <div class="tab-content" id="nav-tabContent">
                    ...
                    <div class="tab-pane fade" id="nav-profile" role="tabpanel" aria-labelledby="nav-profile-tab">x</div>
                </div>
            </div>
        </div>
    </section>
